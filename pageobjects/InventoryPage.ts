...
export class InventoryPage {
  private static readonly L = {
    ...
    nameAToZSelect: [
      { strategy: 'text' as const, value: 'Name (A to Z) Name (Z to A) Price (low to high) Price (high to low)', actionKind: 'combobox' as const },
      { strategy: 'text' as const, value: 'Name (A to Z) Name (Z to A) Price (low to high)', actionKind: 'combobox' as const },
    ],
    ...
    addToCartSauceLabsBackpack: [
      { strategy: 'role' as const, value: 'Add to cart', role: 'button', actionKind: 'button' as const },
      { strategy: 'css' as const, value: '#add-to-cart-sauce-labs-backpack[name="add-to-cart-sauce-labs-backpack"]', actionKind: 'button' as const },
      { strategy: 'css' as const, value: '[name="add-to-cart-sauce-labs-backpack"]', actionKind: 'button' as const },
      { strategy: 'text' as const, value: 'Add to cart', actionKind: 'button' as const },
    ],
    item0Img: { strategy: 'css' as const, value: '#item_0_img_link', actionKind: 'link' as const },
    sauceLabsBikeLight: [
      { strategy: 'role' as const, value: 'Sauce Labs Bike Light', role: 'link', actionKind: 'link' as const },
      { strategy: 'css' as const, value: '#item_0_title_link', actionKind: 'link' as const },
      { strategy: 'text' as const, value: 'Sauce Labs Bike Light', actionKind: 'link' as const },
    ],
    addToCartSauceLabsBikeLight: [
      { strategy: 'role' as const, value: 'Add to cart', role: 'button', actionKind: 'button' as const },
      { strategy: 'css' as const, value: '#add-to-cart-sauce-labs-bike-light[name="add-to-cart-sauce-labs-bike-light"]', actionKind: 'button' as const },
      { strategy: 'css' as const, value: '[name="add-to-cart-sauce-labs-bike-light"]', actionKind: 'button' as const },
      { strategy: 'text' as const, value: 'Add to cart', actionKind: 'button' as const },
    ],
    item1Img: { strategy: 'css' as const, value: '#item_1_img_link', actionKind: 'link' as const },
    sauceLabsBoltTShirt: [
      { strategy: 'role' as const, value: 'Sauce Labs Bolt T-Shirt', role: 'link', actionKind: 'link' as const },
      { strategy: 'css' as const, value: '#item_1_title_link', actionKind: 'link' as const },
      { strategy: 'text' as const, value: 'Sauce Labs Bolt T-Shirt', actionKind: 'link' as const },
    ],
    addToCartSauceLabsBoltTShirt: [
      { strategy: 'role' as const, value: 'Add to cart', role: 'button', actionKind: 'button' as const },
      { strategy: 'css' as const, value: '#add-to-cart-sauce-labs-bolt-t-shirt[name="add-to-cart-sauce-labs-bolt-t-shirt"]', actionKind: 'button' as const },
      { strategy: 'css' as const, value: '[name="add-to-cart-sauce-labs-bolt-t-shirt"]', actionKind: 'button' as const },
      { strategy: 'text' as const, value: 'Add to cart', actionKind: 'button' as const },
    ],
    item5Img: { strategy: 'css' as const, value: '#item_5_img_link', actionKind: 'link' as const },
    sauceLabsFleeceJacket: [
      { strategy: 'role' as const, value: 'Sauce Labs Fleece Jacket', role: 'link', actionKind: 'link' as const },
      { strategy: 'css' as const, value: '#item_5_title_link', actionKind: 'link' as const },
      { strategy: 'text' as const, value: 'Sauce Labs Fleece Jacket', actionKind: 'link' as const },
    ],
    addToCartSauceLabsFleeceJacket: [
      { strategy: 'role' as const, value: 'Add to cart', role: 'button', actionKind: 'button' as const },
      { strategy: 'css' as const, value: '#add-to-cart-sauce-labs-fleece-jacket[name="add-to-cart-sauce-labs-fleece-jacket"]', actionKind: 'button' as const },
      { strategy: 'css' as const, value: '[name="add-to-cart-sauce-labs-fleece-jacket"]', actionKind: 'button' as const },
      { strategy: 'text' as const, value: 'Add to cart', actionKind: 'button' as const },
    ],
    item2Img: { strategy: 'css' as const, value: '#item_2_img_link', actionKind: 'link' as const },
    sauceLabsOnesie: [
      { strategy: 'role' as const, value: 'Sauce Labs Onesie', role: 'link', actionKind: 'link' as const },
      { strategy: 'css' as const, value: '#item_2_title_link', actionKind: 'link' as const },
      { strategy: 'text' as const, value: 'Sauce Labs Onesie', actionKind: 'link' as const },
    ],
    addToCartSauceLabsOnesie: [
      { strategy: 'role' as const, value: 'Add to cart', role: 'button', actionKind: 'button' as const },
      { strategy: 'css' as const, value: '#add-to-cart-sauce-labs-onesie[name="add-to-cart-sauce-labs-onesie"]', actionKind: 'button' as const },
      { strategy: 'css' as const, value: '[name="add-to-cart-sauce-labs-onesie"]', actionKind: 'button' as const },
      { strategy: 'text' as const, value: 'Add to cart', actionKind: 'button' as const },
    ],
    item3Img: { strategy: 'css' as const, value: '#item_3_img_link', actionKind: 'link' as const },
    testAllTheThingsTShirtRed: [
      { strategy: 'role' as const, value: 'Test.allTheThings() T-Shirt (Red)', role: 'link', actionKind: 'link' as const },
      { strategy: 'css' as const, value: '#item_3_title_link', actionKind: 'link' as const },
      { strategy: 'text' as const, value: 'Test.allTheThings() T-Shirt (Red)', actionKind: 'link' as const },
    ],
    addToCartTestAllthethingsTShirtRed: [
      { strategy: 'role' as const, value: 'Add to cart', role: 'button', actionKind: 'button' as const },
      { strategy: 'css' as const, value: '#add-to-cart-test.allthethings()-t-shirt-(red)[name="add-to-cart-test.allthethings()-t-shirt-(red)"]', actionKind: 'button' as const },
      { strategy: 'css' as const, value: '[name="add-to-cart-test.allthethings()-t-shirt-(red)"]', actionKind: 'button' as const },
      { strategy: 'text' as const, value: 'Add to cart', actionKind: 'button' as const },
    ],
    twitter: [
  ...
  async clickA(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, InventoryPage.L.a));
  }

  async doubleClickA(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, InventoryPage.L.a));
  }

  async expectAVisible(timeoutMs = 30_000): Promise<void> {
    await expectVisible(webLocator(this.page, InventoryPage.L.a), timeoutMs);
  }

  async expectAHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, InventoryPage.L.a), timeoutMs);
  }

  async expectAText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, InventoryPage.L.a), expected, timeoutMs);
  }

  async expectAContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, InventoryPage.L.a), substring, timeoutMs);
  }

  async scrollAIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, InventoryPage.L.a));
  }
